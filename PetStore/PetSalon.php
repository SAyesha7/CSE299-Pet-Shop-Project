...
*/
try{
 $stmt = $db->prepare("INSERT INTO `salonappointment`(`ownername`, `email`, `petname`, `petspecies`, `vet`, `reason`, `comments`) VALUES (?,?,?,?,?,?,?)");
       $stmt->bind_param('sssssss',$_POST['owner'],$_POST['email'],$_POST['petname'],$_POST['vet'],$_POST['petType'],$_POST['reason'],$_POST['comments']);
        $stmt->execute();
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                  ...
                  <li><a class="dropdown-item" href="indexe.html">Cages</a></li>
              </ul>
            </li>
            <li class="nav-item dropdown">
              <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
...
<div class= container-fluid>
    ...
    <h4 class="text-center">Pet Salon Appointment Scheduling</h4>

    <form method="post">
   <label for="onwer">Name</label>
...
<div class="row g-2">
    ...
    <div class="col-md">
      <div class="form-floating">
        <select class="form-select" id="petType" name="petType" aria-label="Floating label select example">
...
<div class="col-md">
    <div class="form-floating">
      <select class="form-select" id="vet" name="vet" aria-label="Floating label select example">
        <option selected>Select Pet Groomer to book an appointment with</option>
        <option value="1">Groomer1</option>
        <option value="2">Groomer2</option>
        <option value="3">Groomer3</option>
      </select>
      <label for="vet">Pet Hairdressers Available</label>
    </div>
  </div>
...
<br>
<div class="mb-3">
  <label for="comments" class="form-label"><h6>Comments</h6></label>
